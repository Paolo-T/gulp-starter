...
function Contact() {
  ...
  return (
     <div className="bg-lessDark p-8 md:p-20 mb-20 md:flex text-left">
        <div className="flex-1">
           <p className="text-grey mb-3">Say Hello</p>
           <h3 className="mb-6 leading-7 text-3xl md:text-4xl mb-0 hover:underline hover:underline-offset-4 transition duration-300 ease-in-out">
        ...
        <div className="w-4/12 md:w-2/12 flex items-center justify-between md:justify-around pt-5">
           <a rel="noopener noreferrer" target="_blank" href="https://www.linkedin.com/in/paolo-todde/">
              <svg viewBox="0 0 24 24" className="w-7" fill="grey">
